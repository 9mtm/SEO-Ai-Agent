...
const Modal = ({ children, width = '1/2', maxWidth = 'max-w-[340px] lg:max-w-md', closeModal, title, verticalCenter = false }: ModalProps) => {
   ...
   return (
      <div className='modal fixed top-0 left-0 bg-white/[.7] w-full h-screen z-50' onClick={closeOnBGClick}>
         <div
            className={`modal__content ${maxWidth} absolute left-0 right-0 ml-auto mr-auto w-${width} 
         bg-white shadow-md rounded-md p-5 border-t-[1px] border-gray-100 text-base 
