                            ...
                            <>
                                <div className="relative">
                                    ...
                                    >
                                        ...
                                        {locale === 'de' ? 'DE' : locale === 'fr' ? 'FR' : locale === 'es' ? 'ES' : locale === 'it' ? 'IT' : locale === 'pt' ? 'PT' : locale === 'zh' ? 'ZH' : locale === 'nl' ? 'NL' : 'EN'}
                                    </button>
                                    {langMenuOpen && (
            ...
            {mobileMenuOpen && (
                <div className="md:hidden border-t border-neutral-200 bg-white">
                    <div className="px-4 py-4 space-y-3">
                        ...
                        {!isLoggedIn && (
                            <>
                                <select value={locale} onChange={(e) => setLocale(e.target.value as 'en' | 'de' | 'fr' | 'es' | 'it' | 'pt' | 'zh' | 'nl')} className="w-full px-3 py-2 bg-neutral-100 rounded-lg text-sm font-medium text-neutral-700">
