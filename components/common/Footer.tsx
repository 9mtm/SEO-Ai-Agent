         ...
         <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
               ...
               <div>
                  ...
                  <ul className="space-y-2 text-sm">
                     ...
                     <li><Link href="/mcp-seo" className="hover:text-white transition-colors">{t('nav.mcpIntegration')}</Link></li>                      <li><Link href="/seo-expert-skill" className="hover:text-white transition-colors">{t('footerMenu.seoExpertSkill')}</Link></li>
               ...
               <div>
                  ...
                  <ul className="space-y-2 text-sm">
                     <li><Link href="/blog" className="hover:text-white transition-colors">{t('footerMenu.blog')}</Link></li>
                     <li><Link href="/contact" className="hover:text-white transition-colors">{t('footerMenu.contact')}</Link></li>
                     <li><Link href="/docs/api" className="hover:text-white transition-colors">{t('footerMenu.documentation')}</Link></li>
                     <li><Link href="/#faq" className="hover:text-white transition-colors">{t('footerMenu.faq')}</Link></li>
                  </ul>
               </div>
               ...
               <div>
                  ...
                  <ul className="space-y-2 text-sm">
                     <li><Link href="/imprint" className="hover:text-white transition-colors">{t('footerMenu.imprint')}</Link></li>
                     <li><Link href="/privacy" className="hover:text-white transition-colors">{t('footerMenu.privacyPolicy')}</Link></li>
                     <li><Link href="/terms" className="hover:text-white transition-colors">{t('footerMenu.termsOfService')}</Link></li>
                  </ul>
               </div>
            </div>
            ...
            <div className="border-t border-neutral-800 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
               <p className="text-sm text-neutral-400">
                  © 2026 SEO Agent by <a href="https://dpro.at" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">Dpro GmbH</a>. {t('landing.footer.rights')}
               </p>
               ...
               <div className="flex items-center gap-4">
                  ...
                  <button
                     ...
                     aria-label={t('footerMenu.consentPreferences')}
                  >
                     ...
                     <span>{t('footerMenu.consentPreferences')}</span>
                  </button>
                  ...
                  <button
                     ...
                     className="flex items-center gap-2 text-sm text-neutral-400 hover:text-white transition-colors underline decoration-1 underline-offset-2"
                     aria-label={t('footerMenu.accessibility')}
                  >
                     ...
                     <span>{t('footerMenu.accessibility')}</span>
                  </button>
               </div>
            </div>
         </div>
