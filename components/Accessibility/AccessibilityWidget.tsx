...
export default function AccessibilityWidget() {
    ...
    const { hasActiveSettings } = useAccessibility();
        ...
        <>
            ...
            {showButton && (
                <button
                    ...
                    className="fixed right-0 top-1/2 -translate-y-1/2 z-[9998] bg-blue-600 text-white p-4 rounded-l-2xl shadow-lg hover:shadow-xl transition-all hover:-translate-x-1 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
