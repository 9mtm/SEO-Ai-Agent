               ...
               <ul className='keyword_options customShadow absolute w-[160px] right-0 bg-white rounded-xl border border-gray-100/50 shadow-xl z-20 py-1 overflow-hidden'>
                  <li>
                     <a className='flex items-center gap-2 px-4 py-2.5 text-xs font-medium text-gray-600 hover:bg-gray-50 hover:text-indigo-600 cursor-pointer transition-colors'
                        onClick={() => { refreshkeyword([ID]); setShowOptions(false); }}>
                        <Icon type="reload" size={14} classes="text-indigo-500" /> {t('trackingTable.refresh')}
                     </a>
                  </li>
                  <li>
                     <a className='flex items-center gap-2 px-4 py-2.5 text-xs font-medium text-gray-600 hover:bg-gray-50 hover:text-yellow-600 cursor-pointer transition-colors'
                        onClick={() => { favoriteKeyword({ keywordID: ID, sticky: !sticky }); setShowOptions(false); }}>
                        <Icon type={sticky ? 'star-filled' : 'star'} size={14} classes={sticky ? 'text-yellow-400' : 'text-gray-400'} />
                        {sticky ? t('trackingTable.unfavorite') : t('trackingTable.favorite')}
                     </a>
                  </li>
                  <li>
                     <a className='flex items-center gap-2 px-4 py-2.5 text-xs font-medium text-gray-600 hover:bg-gray-50 hover:text-green-600 cursor-pointer transition-colors'
                        onClick={() => { manageTags(); setShowOptions(false); }}>
                        <Icon type="tags" size={14} classes="text-green-500" /> {t('trackingTable.tag')}
                     </a>
                  </li>
                  ...
                  <li>
                     <a className='flex items-center gap-2 px-4 py-2.5 text-xs font-medium text-red-600 hover:bg-red-50 cursor-pointer transition-colors'
                        onClick={() => { removeKeyword([ID]); setShowOptions(false); }}>
